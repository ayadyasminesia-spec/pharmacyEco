...
import static com.ayadyasmine.pharmacyecom.domain.CategoryAsserts.*;
...
import com.ayadyasmine.pharmacyecom.domain.Category;
import com.ayadyasmine.pharmacyecom.repository.CategoryRepository;
import com.ayadyasmine.pharmacyecom.service.CategoryService;
import com.ayadyasmine.pharmacyecom.service.dto.CategoryDTO;
import com.ayadyasmine.pharmacyecom.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    public static Category createEntity() {
        return new Category().name(DEFAULT_NAME).slug(DEFAULT_SLUG).description(DEFAULT_DESCRIPTION).active(DEFAULT_ACTIVE);
    }
    ...
    public static Category createUpdatedEntity() {
        return new Category().name(UPDATED_NAME).slug(UPDATED_SLUG).description(UPDATED_DESCRIPTION).active(UPDATED_ACTIVE);
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).slug(UPDATED_SLUG).description(UPDATED_DESCRIPTION).active(UPDATED_ACTIVE);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).slug(UPDATED_SLUG).description(UPDATED_DESCRIPTION).active(UPDATED_ACTIVE);
