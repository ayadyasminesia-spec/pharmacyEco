...
/**
 * REST controller for managing {@link com.ayadyasmine.pharmacyecom.domain.Customer}.
 */
@RestController
...
public class CustomerResource {
     ...
     */
    @GetMapping("")
    public List<CustomerDTO> getAllCustomers(@RequestParam(name = "eagerload", required = false, defaultValue = "true") boolean eagerload) {
