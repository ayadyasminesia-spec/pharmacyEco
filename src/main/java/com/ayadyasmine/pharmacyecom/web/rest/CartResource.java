...
import com.ayadyasmine.pharmacyecom.security.SecurityUtils;
import com.ayadyasmine.pharmacyecom.service.CartService;
...
/**
 * REST controller for managing {@link com.ayadyasmine.pharmacyecom.domain.Cart}.
 */
@RestController
...
public class CartResource {
     ...
     */
    @GetMapping("")
    public List<CartDTO> getAllCarts(@RequestParam(name = "filter", required = false) String filter) {
    ...
    public ResponseEntity<Void> addVariantToCart(@RequestParam Long variantId, @RequestParam Integer quantity) {
        // Sécurité : On récupère le login de l'utilisateur connecté via le Token JWT
        String login = SecurityUtils.getCurrentUserLogin()
            .orElseThrow(() -> new RuntimeException("Utilisateur non authentifié"));

        cartService.addVariantToCart(variantId, quantity, login);
