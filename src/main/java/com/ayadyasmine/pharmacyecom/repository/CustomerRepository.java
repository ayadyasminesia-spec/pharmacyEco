...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    @Query("select customer from Customer customer left join fetch customer.user where customer.user.login = :login")
    Optional<Customer> findByUserLogin(@Param("login") String login);
}
