...
import com.ayadyasmine.pharmacyecom.domain.Authority;
...
import com.ayadyasmine.pharmacyecom.repository.AuthorityRepository;
...
import com.ayadyasmine.pharmacyecom.web.rest.vm.ManagedUserVM;
...
public class UserService {
    ...
    public User registerUser(ManagedUserVM userDTO, String password) {
        ...
        customer.setPhone(userDTO.getPhoneNumber()); // Use phone from DTO
        customer.setCreatedAt(Instant.now());
        customerRepository.save(customer);

        // Create the active cart for this customer
        Cart cart = new Cart();
        ...
        // Update customer with the cart reference
