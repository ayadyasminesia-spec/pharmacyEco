...
/**
 * Criteria class for the {@link com.ayadyasmine.pharmacyecom.domain.Category} entity. This class is used
 * in {@link com.ayadyasmine.pharmacyecom.web.rest.CategoryResource} to receive all the possible filtering options from
...
public class CategoryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, slug, description, active, parentId, distinct);
    }
