...
/**
 * Criteria class for the {@link com.ayadyasmine.pharmacyecom.domain.Review} entity. This class is used
 * in {@link com.ayadyasmine.pharmacyecom.web.rest.ReviewResource} to receive all the possible filtering options from
...
public class ReviewCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, rating, comment, createdAt, productId, customerId, distinct);
    }
